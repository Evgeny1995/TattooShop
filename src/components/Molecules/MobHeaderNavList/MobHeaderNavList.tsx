...
const MobHeaderNavList: React.FC = () => {
  ...
  const { mobCatalogCategoryDataList, mobCatalogCategoryDataList2 } =
    useTypedSelector((state) => state.listState);
  const { getMobCatalogCategoryDataList, getMobCatalogCategoryDataList2 } =
    useActions();
