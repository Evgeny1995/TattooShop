      ...
      <div className={styles.help_content_container}>
        ...
        <div className={styles.help_content}>
          ...
          <p className={styles.help_title_description}>
            ...
            methods like string and pen paste, you, as a reasonable person, do
            not are considering and realize that you will need some minimum set
            of equipment. What should it contain? This is what everyone asks
            novice tattoo artists at the beginning of their activities. Let's
            try to help.
          </p>
          ...
          <div className={styles.desk_border}>
            ...
            <h5 className={styles.manufacturers_tattoo_machines_title}>
              Manufacturers of tattoo machines - why are they more expensive
              than others?
            </h5>
            ...
            <h4 className={styles.tattoo_holders_title}>Tattoo holders</h4>
            <h5 className={styles.reusable_disposable_holders_tattoo_title}>
            ...
            <ul className={styles.cartridges_needles_holders_list}>
              <li className={styles.cartridges_needles_holders_item}>
                <a className={styles.cartridges_needles_holders_item} href="">
          ...
          <div className={styles.tattoo_machine_what_style}>
            <p className={styles.main_tool_text}>
              The main tool of a tattoo artist, with which, as a rule, they
              begin to assemble their first set of tattoo equipment. Let's not
              change this stereotype, and let's talk about cars.
            </p>

            <p className={styles.operating_principle_text}>
              Machines, based on their operating principle, are divided into
              induction and rotary. Induction, in turn, are divided into liners
              and shaders.
            </p>
            <p className={styles.electrical_device_text}>
              A tattoo machine is an electrical device that drives a tattoo
              needle. Regardless of the type, the following requirements apply
            ...
            <ul className={styles.requirements_tattoo_machine_list}>
              <li className={styles.requirements_tattoo_machine_item}>
                light weight - a light machine is more convenient to work with;
              </li>
              <li className={styles.requirements_tattoo_machine_item}>
                minimum vibrations - this type of machine makes it easier to
                make precise drawings;
              </li>
              <li className={styles.requirements_tattoo_machine_item}>
                power - piercing the skin with a frequency of several tens of
                blows per second is not so easy;
              </li>
              <li className={styles.requirements_tattoo_machine_item}>
                high-quality assembly - tattoo machines are subject to
                considerable loads and must withstand them for a long time;
              </li>
              <li className={styles.requirements_tattoo_machine_item}>
                reliability - this should mean not only the tendency of a
                particular model to break down, but the ability to work for a
                long time without overheating and sagging characteristics;
              </li>
              <li className={styles.requirements_tattoo_machine_item}>
                A beautiful appearance is not as unimportant as it seems.
              </li>
            </ul>
            <p className={styles.manufacturing_balance_text}>
              If you are not unfamiliar with mechanics and you understand the
              principles of operation of simple mechanisms, then you will see
              that the requirements are very contradictory. It is easier to
              ensure a minimum of vibrations and maximum power on a device with
              a larger mass, but working with a heavy machine is not so easy.
              This also includes the quality of the assembly and the design in
              general - vibration has a destructive effect on all elements of
              the device. Finding that balance that most tattoo artists will
              like is the art of the manufacturer. Finding those models that are
              easy, convenient and comfortable to work with is the task of the
              tattoo artist.
            </p>
            <img
